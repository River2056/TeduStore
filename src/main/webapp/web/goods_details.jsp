...
<div id="shop_detail">
    ...
    <div class="right_detail lf">
        ...
        <!-- 价格部分-->
        <div class="price">
            <div id="pro_price"><b>學員售價：</b><span>￥${goods.price }.00</span></div>
            <div class="promise">
                <b>服務承諾：</b>
                <span>*退貨補運費</span>
                <span>*30天無憂退貨</span>
        ...
        <p class="parameter">
            <b>客服：</b>
            <span class="connect">聯繫客服</span><img class="gif" src="../images/product_detail/kefuf.gif">
        </p>
        <!-- 颜色-->
	    ...
	    <p class="accountChose">
		    <form id="buyForm">
		        <h5 class="title">數量：</h5>
		        <input type="button" value="-" class="numberMinus"/>
		        <input type="text" value="1" class="number" id="buy-num" name="goodsCount">
		        <input type="button" value="+" class="numberAdd"/>
		        <input type="hidden" name="goodsId" value="${goods.id }"/>
		        <input type="hidden" name="goodsImage" value="${goods.image }"/>
		        <input type="hidden" name="goodsTitle" value="${goods.title }"/>
		        <input type="hidden" name="goodsItemType" value="${goods.itemType }"/>
		        <input type="hidden" name="goodsPrice" value="${goods.price }"/>
		    </form>
	    </p>
        <!-- 购买部分-->
        <div class="shops">
            <a href="cart.html" class="buy lf" id="buy_now">立即購買</a>
            <a href="#" class="shop lf" id="add_cart"><img src="../images/product_detail/product_detail_img7.png" alt=""/>加入購物車</a>
...
//         })
    ...
    $("#collect").click(function (e){
		...
		if (!color || !norms ) {
            ...
            $(".modal").show();
            $(".modal_information span").html("是否將您的寶貝加入收藏夾");
        }
    })
    $('.no').click(function(){
        $('.modal').hide();
